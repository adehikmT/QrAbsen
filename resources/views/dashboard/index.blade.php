...
<div class="parallax-content baner-content" id="home">
        <div class="container">
            <div class="text-content">
                <h2><em>ABSENSI</em> <span>SCAN</span> QRCODE</h2>
                <p>Website Aplikasi Absensi menggunakan QRcode SMKN 1 Kawali <br>
                SMK Bisa SMK Hebat SMK PASTI BISA.</p>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="service-item">
                        <div class="icon">
                            <img src="{{url('assets')}}/img/service_icon_01.png" alt="">
                        </div>
                        <h4>Smart School</h4>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="service-item">
                        <div class="icon">
                            <img src="{{url('assets')}}/img/service_icon_02.png" alt="">
                        </div>
                        <h4>Smart Technologi</h4>
                        <div class="line-dec"></div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="service-item">
                        <div class="icon">
                            <img src="{{url('assets')}}/img/service_icon_03.png" alt="">
                        </div>
                        <h4>Efficient</h4>
                        <div class="line-dec"></div>
                            ...
                            <div class="projects-holder">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 project-item mix nature">
                                      <div class="thumb">
                                            <div class="image">
                                                <a href="img/portfolio_big_item_01.jpg" data-lightbox="image-1"><img src="{{url('assets')}}/img/portfolio_item_01.jpg"></a>
                                            </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix animation">
                                      <div class="thumb">
                                        <div class="image">
                                                <a href="img/portfolio_big_item_02.jpg" data-lightbox="image-1"><img src="{{url('assets')}}/img/portfolio_item_02.jpg"></a>
                                            </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix branding">
                                      <div class="thumb">
                                            <div class="image">
                                                <a href="img/portfolio_big_item_03.jpg" data-lightbox="image-1"><img src="{{url('assets')}}/img/portfolio_item_03.jpg"></a>
                                            </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix graphic nature">
                                        <div class="thumb">
                                            <div class="image">
                                                <a href="img/portfolio_big_item_04.jpg" data-lightbox="image-1"><img src="{{url('assets')}}/img/portfolio_item_04.jpg"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix branding">
                                      <div class="thumb">
                                            <div class="image">
                                                <a href="img/portfolio_big_item_05.jpg" data-lightbox="image-1"><img src="{{url('assets')}}/img/portfolio_item_05.jpg"></a>
                                            </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix graphic animation">
                                        <div class="thumb">
                                            <div class="image">
                                                <a href="img/portfolio_big_item_06.jpg" data-lightbox="image-1"><img src="{{url('assets')}}/img/portfolio_item_06.jpg"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="wrapper">
                    ...
                    <div class="col-md-8">
                        <section id="first-tab-group" class="tabgroup">
                            <div id="tab1">
                                <img src="{{url('assets')}}/img/blog_item_01.jpg" alt="">
                                <div class="text-content">
                            ...
                            <div id="tab2">
                                <img src="{{url('assets')}}/img/blog_item_02.jpg" alt="">
                                <div class="text-content">
                            ...
                            <div id="tab3">
                                <img src="{{url('assets')}}/img/blog_item_03.jpg" alt="">
                                <div class="text-content">
                            ...
                            <div id="tab4">
                                <img src="{{url('assets')}}/img/blog_item_04.jpg" alt="">
                                <div class="text-content">
    ...
    <div id="map">
    	<!-- How to change your own map point
            ...
            4. Copy only URL and paste it within the src="{{url('assets')}}/" field below
        -->
        <iframe src="{{url('assets')}}/https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7895.485196115994!2d103.85995441789784!3d1.2880401763270322!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x7fb4e58ad9cd826e!2sSingapore+Flyer!5e0!3m2!1sen!2sth!4v1505825620371" width="100%" height="500" frameborder="0" style="border:0" allowfullscreen></iframe>
    </div>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <div class="logo">
                        <a class="logo-ft scroll-top" href="#"><em>A</em>BSQR</a>
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="location">
                        <h4>Location</h4>
                        <ul>
                        <li>SMKN 1 Kawali, <br>Jln Talagasari no 35</li>
                        </ul>
                    </div>
                </div>
